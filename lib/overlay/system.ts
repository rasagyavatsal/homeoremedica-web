  ...
  "z-50 border border-border bg-popover text-popover-foreground shadow-overlay outline-none",
  {
    variants: {
      variant: {
        ...
        sheetSide: `overlay-sheet-side-position fixed inset-y-0 left-0 flex h-dvh w-3/4 flex-col overflow-hidden rounded-r-2xl ${motionClassNames.overlaySheetSide}`,
